...
public class FeatureProdutoDao extends SimpleDao {

	public FeatureProdutoDao(SessionFactory sessionFactory) {
		super(sessionFactory, "FeatureProduto");
	}

	@Override
	public void delete(IEntidade entidate) throws Exception {
		FeatureProduto objeto = (FeatureProduto) entidate;

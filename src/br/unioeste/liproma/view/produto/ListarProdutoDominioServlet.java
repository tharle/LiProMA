...
@WebServlet("/ListarProdutoDominio.form")
public class ListarProdutoDominioServlet extends HttpServlet {
	 ...
	 */
	public ListarProdutoDominioServlet() {
		super();
		...
		try {
			...
			if (parameterMap != null
				...
				dominiosSelecionados = controle
						.buscarDominiosPorProduto(idProduto);
			}
			...
			result.put("produtoDominios", AdapterUtils.toJSONArrayAdapter(dominios));

 ...
 */
@WebServlet("/CriarDominio.form")
public class CriarDominioServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		try {
			...
			dominio.processJsonObject(
					(org.json.JSONObject) jsonObj.get("dominios"),true);
			controlador.gravar(dominio, true);

 ...
 */
@WebServlet("/CriarBacklogEscopo.form")
public class CriarBacklogEscopoServlet extends HttpServlet {
	 ...
	 */
	public CriarBacklogEscopoServlet() {
		super();
	...
	protected void doPost(HttpServletRequest request,
		...
		try {
			...
			backlogEscopo.fromJsonObject(
					(org.json.JSONObject) jsonObj.get("backlogEscopos"),true);
			controlador.gravar(backlogEscopo, true);

...
@WebServlet("/ListarFeatureDominio.form")
public class ListarFeatureDominioServlet extends HttpServlet {
	 ...
	 */
	public ListarFeatureDominioServlet() {
		super();
	...
	private void doRequest(HttpServletRequest request,
		...
		try {
			...
			if (parameterMap != null
					&& parameterMap.containsKey("featureId")) {
				String idFeature= request
						.getParameter("featureId");
				dominiosSelecionados = controle
						.buscarDominiosPorFeature(idFeature);
			}
			...
			result.put("featureDominios", AdapterUtils.toJSONArrayAdapter(dominios));
